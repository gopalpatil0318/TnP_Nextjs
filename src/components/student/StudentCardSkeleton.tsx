...
export default function StudentCardSkeleton() {
  return (
    <Card className="w-64 bg-white shadow-lg mt-20 rounded-lg relative overflow-hidden">
      <div className="h-24 bg-gray-200" />
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="w-[120px] h-[120px] rounded-lg bg-gray-300 animate-pulse" />
      </div>
      <div className="pt-4 pb-4 px-4">
        <div className="h-6 bg-gray-300 rounded w-3/4 mx-auto mt-2 mb-1 animate-pulse" />
