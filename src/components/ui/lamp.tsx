...
export function HeroTraningProgram() {
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-slate-300 to-slate-300 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-black md:text-7xl"
      >
        Training Courses
      </motion.h1>
      <motion.h1
        ...
        className="mt-2 bg-gradient-to-br from-slate-300 to-slate-300 py-4 bg-clip-text text-center text-xl font-medium tracking-tight text-black md:text-4xl"
      >
        By Training and Placement Department
      </motion.h1>
    </LampContainer>
  );
}
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[40rem] flex-col items-center justify-center overflow-hidden bg-white w-full rounded-md z-0",
        className
      )}
    >
